...
class TabView(tk.Frame):
    ...
    def _tab_add(self, event):
        ...
        if not self._generate_func:
            self.add_tab(tk.Frame(self.body), "编码工具")
        else:
            self.add_tab(self._generate_func(), "编码工具")
